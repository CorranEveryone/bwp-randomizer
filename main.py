...
# CONFIG
gamemode = "Autobox" # Pick a gamemode from above
...
if gamemode == "Bed Bridge Fight":
    ...
    itemdefs = [
        ...
        {"name":"Allow Projectiles", "rank":"Adept"},
        {"name":"Increased Diamond Costs", "rank":"Adept"},
        {"name":"Increase Distance Between Islands", "rank":"Master"}
    ]
elif gamemode == "Bedwalls":
    if playerrank == "Master":
        ...
        print("You must be Master Rank for this gameemode.")
        exit()
elif gamemode == "Ranked Fours Practice":
    fullpages = 2
    lastpage_fullrows = 0
    lastrow_items = 3
    itemdefs = [
...
elif gamemode == "Bedwars Rush Duels":
    fullpages = 1
    lastpage_fullrows = 1
    lastrow_items = 4
    itemdefs = [
    ...
    itemdefs = [
        ...
        {"name":"Allow Armour Swapping"},
        {"name":"Explosion Power", "rank":"Expert"},
        {"name":"Arena Move Speed", "rank":"Adept"},
        {"name":"Arena Radius Multiplier", "rank":"Adept"},
        {"name":"Jump Boost Effect", "rank":"Adept"},
        {"name":"Speed Effect", "rank":"Adept"},
        {"name":"Blindness Effect", "rank":"Expert"},
        {"name":"Health", "rank":"Expert"},
